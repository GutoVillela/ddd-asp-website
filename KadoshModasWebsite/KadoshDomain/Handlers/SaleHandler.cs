...
{
    public class SaleHandler : Notifiable<Notification>, IHandler<CreateSaleInCashCommand>, IHandler<CreateSaleInInstallmentsCommand>, IHandler<CreateSaleOnCreditCommand>, IHandler<PayOffSaleCommand>
    {
        ...
        public async Task<ICommandResult> HandleAsync(PayOffSaleCommand command)
        {
            try
            {
                // Fail Fast Validation
