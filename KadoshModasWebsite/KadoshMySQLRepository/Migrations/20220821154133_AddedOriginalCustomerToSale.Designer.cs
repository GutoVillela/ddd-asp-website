...
namespace KadoshRepository.Migrations
{
    ...
    [Migration("20220821154133_AddedOriginalCustomerToSale")]
    partial class AddedOriginalCustomerToSale
    {
            ...
            modelBuilder.Entity("KadoshDomain.Entities.Sale", b =>
                {
                    ...
                    b.HasOne("KadoshDomain.Entities.Customer", "OriginalCustomer")
                        .WithMany("OriginalSales")
                        .HasForeignKey("OriginalCustomerId");
